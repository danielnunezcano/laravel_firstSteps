...
class LibrosAutoresSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        LibrosAutore::create(['fk_libros' => '5', 'fk_autores' => '8', 'fecha' => '2018-03-12']);
        LibrosAutore::create(['fk_libros' => '6', 'fk_autores' => '9', 'fecha' => '2018-01-15']);
        LibrosAutore::create(['fk_libros' => '7', 'fk_autores' => '10', 'fecha' => '2018-02-03']);
        LibrosAutore::create(['fk_libros' => '8', 'fk_autores' => '11', 'fecha' => '2018-04-07']);
    }
}
